...
public class EmpleadoDAO {
    ...
    private PreparedStatement preparedStatement;    // mejor PS que statement
    ...
    public void insertarEmpleado(Empleado empleado) throws SQLException {
        preparedStatement = connection.prepareStatement(String.format("INSERT INTO %s (%s, $s, %s, %s, %s) VALUES (?,?,?,?,?)",
                SchemaDB.TAB_EMP,
                SchemaDB.COL_EMP_NAME, SchemaDB.COL_EMP_SURNAME, SchemaDB.COL_EMP_PHO, SchemaDB.COL_EMP_MAIL, SchemaDB.COL_EMP_KIN));
